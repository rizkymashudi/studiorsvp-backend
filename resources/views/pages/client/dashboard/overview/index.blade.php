  ...
  <section class="sidebar">
      <div class="content pt-50 pb-30 ps-30">
          <div class="user text-center pb-50 pe-30">
              <img src="{{ url('../assets/img/avatar-1.png') }}" width="90" height="90" class="img-fluid mb-20" />
          ...
          <div class="menus">
              ...
              <div class="item mb-30">
                  ...
                  <p class="item-title m-0">
                      <a href="../member/edit-profile.html" class="text-lg text-decoration-none">Settings</a>
                  </p>
              </div>
              <div class="item mb-30">
                  <svg class="icon me-3" width="25" height="25" viewBox="0 0 25 25" fill="none"
          ...
          <div class="sidebar-footer pt-73 pe-30">
              <div class="footer-card">
                  <div class="d-flex justify-content-between mb-20">
                      ...
                      <p class="fw-medium color-palette-1">Top Up &<br>
                          Be The Winner</p>
                  </div>
                      ...
                      <div class="col-lg-4 ps-15 pe-15 pb-lg-0 pb-4">
                          <div class="categories-card">
                              <div class="d-flex align-items-center mb-24">
                                  ...
                                  <p class="color-palette-1 mb-0 ms-12">Game<br> Desktop</p>
                              </div>
                              <div>
                      ...
                      <div class="col-lg-4 ps-15 pe-15 pb-lg-0 pb-4">
                          <div class="categories-card">
                              <div class="d-flex align-items-center mb-24">
                                  ...
                                  <p class="color-palette-1 mb-0 ms-12">Game<br> Mobile</p>
                              </div>
                              <div>
                                  <p class="text-sm color-palette-2 mb-1">Total Spent</p>
                                  <p class="text-2xl color-palette-1 fw-medium m-0">Rp 8.455.000</p>
                              </div>
                          </div>
                      </div>
                      <div class="col-lg-4 ps-15 pe-15 pb-lg-0 pb-4">
                          <div class="categories-card">
                              <div class="d-flex align-items-center mb-24">
                                  ...
                                  <p class="color-palette-1 mb-0 ms-12">Other<br> Categories</p>
                              </div>
                              <div>
                                  <p class="text-sm color-palette-2 mb-1">Total Spent</p>
                                  <p class="text-2xl color-palette-1 fw-medium m-0">Rp 5.000.000</p>
                              </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <table class="table table-borderless">
                      ...
                      <tbody>
                          <tr class="align-middle">
                              <th scope="row">
                                  <img class="float-start me-3 mb-lg-0 mb-3" src="{{ url('../assets/img/overview-1.png') }}"
                          ...
                          <tr class="align-middle text-center">
                              <th scope="row">
                                  <img class="float-start me-3 mb-lg-0 mb-3" src="{{ url('../assets/img/overview-2.png') }}"
                                      width="80" height="60" alt="">
                                  <div class="game-title-header">
                          ...
                          <tr class="align-middle text-center">
                              <th scope="row">
                                  <img class="float-start me-3 mb-lg-0 mb-3" src="{{ url('../assets/img/overview-3.png') }}"
                                      width="80" height="60" alt="">
                                  <div class="game-title-header">
                          ...
                          <tr class="align-middle text-center">
                              <th scope="row">
                                  <img class="float-start me-3 mb-lg-0 mb-3" src="{{ url('../assets/img/overview-4.png') }}"
                                      width="80" height="60" alt="">
                                  <div class="game-title-header">
