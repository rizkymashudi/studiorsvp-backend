<section class="sidebar">
  <div class="content pt-50 pb-30 ps-30">
      ...
      <div class="menus">
          <div class="item {{ set_active('overview.index') }} mb-30">
              ...
              <p class="item-title m-0">
                  <a href="{{ route('overview.index') }}" class="text-lg text-decoration-none">Overview</a>
              </p>
          </div>
          <div class="item {{ set_active('booking.index') }} mb-30">
          ...
          <div class="item {{ set_active('reservations-history.index') }} mb-30">
              ...
              <p class="item-title m-0">
                  <a href="{{ route('reservations-history.index') }}" class="text-lg text-decoration-none">History</a>
              </p>
          </div>
          <div class="item {{ set_active('profile-settings.index') }} mb-30">
              <svg class="icon me-3" width="25" height="25" viewBox="0 0 25 25" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
              ...
              <p class="item-title m-0">
                  <a href="{{ route('profile-settings.index') }}" class="text-lg text-decoration-none">Settings</a>
              </p>
          </div>
      </div>
  </div>
